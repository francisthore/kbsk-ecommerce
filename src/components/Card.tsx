              ...
              <button
                ...
                className={`${
                  compact
                    ? "w-full"
                    : "flex-1"
                } rounded-md bg-[--color-cta] px-4 py-2 text-body-medium font-medium text-light-100 transition-colors hover:bg-[--color-cta-dark] focus:outline-none focus:ring-2 focus:ring-[--color-cta] focus:ring-offset-2`}
