  ...
  const cardContent = (
    ...
    >
      ...
      >
        ...
        {((colorCount && colorCount > 0) || (sizeCount && sizeCount > 0)) && (
          <div className="mb-3 flex flex-wrap gap-2 text-caption text-dark-700">
            {colorCount && colorCount > 0 && (
              <span className="flex items-center gap-1 rounded-full bg-light-200 px-2 py-1">
        ...
        <div className="mt-auto">
          {price !== undefined && (
            <div className="mb-3 flex items-baseline gap-2">
              ...
              >
                {maxPrice && maxPrice > price && !originalPrice
